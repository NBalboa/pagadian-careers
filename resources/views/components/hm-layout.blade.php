    ...
    <aside id="sidebar"
        ...
        <div
            ...
            <button id="close-sidebar-btn" data-drawer-target="sidebar" data-drawer-toggle="sidebar"
                ...
                class="absolute top-0 right-3 p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg hover:text-blue-800 text-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 z-50 md:hidden">
            ...
            <div class="border-b-4 rounded border-blue-800  ">
                ...
                <span class="ms-1 font-bold text-sm text-center text-blue-100 uppercase font-semibold">Hiring
                    Manager</span>

            </div>
            <ul class="space-y-2 font-medium">
                <x-nav-item href="/hiringmanager/dashboard" :active="Route::is('hm.dashboard')">
                    Dashboard
                </x-nav-item>
                <x-nav-item href="/my/job" :active="Route::is('hm.my.job') ||
