            ...
            <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0  ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" wire:submit.prevent="verifyOTP" wire:loading.class="opacity-50"
                        ...
                        <div>
                            <label for="otp" class="block mb-2 text-sm font-medium text-gray-900">We have sent you
                                an email to complete your account registration.</label>
                        ...
                        <button type="submit" wire:loading.remove wire:target="verifyOTP"
                    ...
                    <div wire:poll.1000ms="calculateTimeRemaining">
                        ...
                        @else
                            <button type="submit" wire:click="resendOTP" wire:loading.remove wire:target="resendOTP"
