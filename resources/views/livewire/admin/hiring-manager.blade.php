<div>
    ...
    @if ($hiring_managers->links())
        <div class="mt-3">
            {{ $hiring_managers->links('pagination::tailwind') }}
        </div>
    @endif

    <a href="/hiringmanager/create" style="float: right; display: inline-block; margin-top: 1rem;" wire:navigate
