    ...
    <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 sm:px-8">
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div class="px-4 text-gray-700">
                <h3 class="text-sm tracking-wider">Total Jobs</h3>
        ...
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div class="px-4 text-gray-700">
                <h3 class="text-sm tracking-wider">Total Applicants</h3>
        ...
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div class="px-4 text-gray-700">
                <h3 class="text-sm tracking-wider">Total Companies</h3>
                <p class="text-3xl">{{ $total_companies }}</p>
            </div>
        </div>
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div class="px-4 text-gray-700">
                <h3 class="text-sm tracking-wider">Total Hiring Managers</h3>
                <p class="text-3xl">{{ $total_hiring_managers }}</p>
            </div>
        </div>
    </div>
</div>
